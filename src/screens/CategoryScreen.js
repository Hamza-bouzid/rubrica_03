      ...
      >
        {contacts && contacts.length <= 0 ? (
          <View style={style.noResult}>
            ...
            <Text style={style.noResultSmallText}>Verifica che non ci siano errori di battitura o  </Text>
            <Text style={style.noResultSmallText}>esegui una nuova ricerca.</Text>
          </View>
        ) : (
